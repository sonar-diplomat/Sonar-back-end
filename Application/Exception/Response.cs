...
public abstract class Response(bool success, int statusCode, string message, string[]? args = null) : System.Exception(message)
{
...
public class OkResponse<T>(T data, string[]? args = null) : Response<T>(data, true, 200, "Operation completed successfully", args);
public class CreatedResponse(string[]? args = null) : Response(true, 201, "Resource created successfully", args);
public class CreatedResponse<T>(T data, string[]? args = null) : Response<T>(data, true, 201, "Resource created successfully", args);
public class AcceptedResponse(string[]? args = null) : Response(true, 202, "Request accepted successfully", args);
public class AcceptedResponse<T>(T data, string[]? args = null) : Response<T>(data, true, 202, "Request accepted successfully", args);
...
public class ProxyAuthenticationRequiredResponse(string[]? args = null) : Response(false, 407, "Proxy authentication required", args);
