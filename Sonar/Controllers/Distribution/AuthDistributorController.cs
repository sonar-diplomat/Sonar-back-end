...
[ApiController]
public class AuthDistributorController(DistributorSessionService sessionService, AuthService authService) : ControllerBase
{
    ...
    public async Task<IActionResult> Login(string accountIdentifier, string password)
    {
        ...
        return Ok("Login successful"); // return token
    }
}
