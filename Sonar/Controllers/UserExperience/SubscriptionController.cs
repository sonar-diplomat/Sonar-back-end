    ...
    : BaseController(userManager)
{
    ...
    public async Task<ActionResult<IEnumerable<SubscriptionPack>>> GetAllPacks()
    {
        ...
        throw ResponseFactory.Create<OkResponse<IEnumerable<SubscriptionPack>>>(packs, ["Subscription packs retrieved successfully"]);
    }
    ...
    public async Task<ActionResult<SubscriptionPayment>> PurchaseSubscription([FromBody] PurchaseSubscriptionDTO dto)
    {
        ...
        throw ResponseFactory.Create<CreatedResponse<SubscriptionPayment>>(payment, ["Subscription purchased successfully"]);
    }
    ...
    public async Task<ActionResult<IEnumerable<SubscriptionPayment>>> GetAllPayments()
    {
        ...
        throw ResponseFactory.Create<OkResponse<IEnumerable<SubscriptionPayment>>>(payments, ["Subscription payments retrieved successfully"]);
    }
    ...
    public async Task<ActionResult<SubscriptionPayment>> GetPayment(int id)
    {
        ...
        throw ResponseFactory.Create<OkResponse<SubscriptionPayment>>(payment, ["Subscription payment retrieved successfully"]);
    }
    ...
    public async Task<ActionResult<IEnumerable<SubscriptionFeature>>> GetAllFeatures()
    {
        ...
        throw ResponseFactory.Create<OkResponse<IEnumerable<SubscriptionFeature>>>(features, ["Subscription features retrieved successfully"]);
    }
    ...
    public async Task<ActionResult<SubscriptionFeature>> GetFeature(int id)
    {
        ...
        throw ResponseFactory.Create<OkResponse<SubscriptionFeature>>(feature, ["Subscription feature retrieved successfully"]);
    }
