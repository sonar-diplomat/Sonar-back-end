...
{
    [Required] public bool AutoPlay { get; set; }

    [Required] public bool Crossfade { get; set; }

    [Required] public bool ExplicitContent { get; set; }

    [Required] public int PreferredPlaybackQualityId { get; set; }

    [Required] public int LanguageId { get; set; }

    [Required] public int ThemeId { get; set; }

    [Required] public int UserPrivacySettingsId { get; set; }
