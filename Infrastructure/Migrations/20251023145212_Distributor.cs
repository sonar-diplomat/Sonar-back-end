        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceName = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    LastActive = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DistributorAccountId = table.Column<int>(type: "integer", nullable: false),
                    RefreshTokenHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Revoked = table.Column<bool>(type: "boolean", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DistributorSession_DistributorAccounts_DistributorAccountId",
                        column: x => x.DistributorAccountId,
                        principalTable: "DistributorAccounts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistributorAccounts_DistributorId",
                table: "DistributorAccounts",
                column: "DistributorId");

            migrationBuilder.CreateIndex(
                name: "IX_DistributorSession_DistributorAccountId",
                table: "DistributorSession",
                column: "DistributorAccountId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Track_HighQualityAudioFileId",
                table: "Track",
                column: "HighQualityAudioFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Track_LowQualityAudioFileId",
                table: "Track",
                column: "LowQualityAudioFileId");

            migrationBuilder.CreateIndex(
                name: "IX_Track_MediumQualityAudioFileId",
                table: "Track",
                column: "MediumQualityAudioFileId");
